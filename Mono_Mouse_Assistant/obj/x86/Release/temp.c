...
extern const unsigned char assembly_data_Mono_Mouse_Assistant_exe [];
static const MonoBundledAssembly assembly_bundle_Mono_Mouse_Assistant_exe = {"Mono_Mouse_Assistant.exe", assembly_data_Mono_Mouse_Assistant_exe, 11264};
extern const unsigned char assembly_data_I18N_West_dll [];
static const MonoBundledAssembly assembly_bundle_I18N_West_dll = {"I18N.West.dll", assembly_data_I18N_West_dll, 72704};
...
static const MonoBundledAssembly *bundled [] = {
	&assembly_bundle_Mono_Mouse_Assistant_exe,
...
static char *image_name = "Mono_Mouse_Assistant.exe";
